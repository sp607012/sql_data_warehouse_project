...
BEGIN
    ...
    BEGIN
        ...
        -- Insert without ON CONFLICT (to match first procedure)
        INSERT INTO bronze.crm_cust_info
        SELECT * FROM stg_cust_info;

        DROP TABLE stg_cust_info;

        RAISE NOTICE 'crm_cust_info loaded successfully in %', clock_timestamp() - t_start;
    EXCEPTION
        WHEN OTHERS THEN
    ...
    BEGIN
        ...
        RAISE NOTICE 'crm_prd_info loaded successfully in %', clock_timestamp() - t_start;
    EXCEPTION
        WHEN OTHERS THEN
    ...
    BEGIN
        ...
        RAISE NOTICE 'crm_sales_details loaded successfully in %', clock_timestamp() - t_start;
    EXCEPTION
        WHEN OTHERS THEN
    ...
    BEGIN
        ...
        RAISE NOTICE 'PX_CAT_G1V2 loaded successfully in %', clock_timestamp() - t_start;
    EXCEPTION
        WHEN OTHERS THEN
    ...
    BEGIN
        ...
        CREATE TEMP TABLE stg_cust_az12 AS
        SELECT * FROM bronze.erp_loc_az12 WHERE false;  -- create empty copy
        ...
        RAISE NOTICE 'CUST_AZ12 loaded successfully in %', clock_timestamp() - t_start;
    EXCEPTION
        WHEN OTHERS THEN
    ...
    BEGIN
        ...
        RAISE NOTICE 'LOC_A101 loaded successfully in %', clock_timestamp() - t_start;
    EXCEPTION
        WHEN OTHERS THEN
